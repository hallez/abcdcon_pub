...
initialize_ABCDCon
curdir = pwd;
outLabel = 'firstlevel_sanityCheck';
b.replace_cons = 0;
...
%generalize the paths, etc, using b variables
    ...
    matlabbatch{9}.spm.stats.fmri_spec.sess(1).multi = {[b.modelDir,'/',b.curSubj,'/sanityCheck_model_',b.curSubj,'_run1_regs.mat']};
    ...
    matlabbatch{9}.spm.stats.fmri_spec.sess(2).multi = {[b.modelDir,'/',b.curSubj,'/sanityCheck_model_',b.curSubj,'_run2_regs.mat']};
    ...
    matlabbatch{9}.spm.stats.fmri_spec.sess(3).multi = {[b.modelDir,'/',b.curSubj,'/sanityCheck_model_',b.curSubj,'_run3_regs.mat']};
    ...
    matlabbatch{9}.spm.stats.fmri_spec.sess(4).multi = {[b.modelDir,'/',b.curSubj,'/sanityCheck_model_',b.curSubj,'_run4_regs.mat']};
