...
load(paste0(analyzed_mri_dir, halle::ensure_trailing_slash("multivariate_sanityCheck"), sprintf('group_spatial_trial_patterns_%02d_truncated_voxels.RData', num_vox)))
load(paste0(analyzed_mri_dir, halle::ensure_trailing_slash("multivariate_sanityCheck"), sprintf('group_temporal_trial_patterns_%02d_truncated_voxels.RData', num_vox)))
...
if(SAVE_GRAPHS_FLAG == 1){
  ggplot2::ggsave(file = file.path(graph_fpath_out,
                                sprintf("sameAll_sameSome_diffAll_left_body_CA1_CA23DG_%02d_truncated_voxels.pdf", num_vox)),
                  width=8, height=6)
}
...
if(SAVE_GRAPHS_FLAG == 1){
  ggplot2::ggsave(file = file.path(graph_fpath_out,
                                sprintf("sameAll_sameSome_diffAll_right_body_CA1_CA23DG_%02d_truncated_voxels.pdf", num_vox)),
                  width=8, height=6)
}
